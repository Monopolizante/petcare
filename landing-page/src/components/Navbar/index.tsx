    ...
    return (
        <header className='md:px-20 px-5 py-6 flex justify-between items-center border-b border-b-[#ccc]'>
            <div className='flex gap-2'>
                ...
                <p className='font-black text-[#153229] text-sm md:text-base'>pet</p>
                <p className='font-black text-[#FF6B4A] text-sm md:text-base'>care</p>
            </div>
            <nav>
            ...
            <a href='' className='hidden md:block bg-[#1F4136] text-white rounded-full font-medium text-sm px-6 py-3 shadow-2xl'>
                Agendar Consulta
            </a>
